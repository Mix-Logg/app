            ...
            <ScrollView style={twrnc`bg-white h-full`}>
                <View style={twrnc`mt-10 px-5`}>
                    <View style={twrnc` px-2 py-3 gap-9`}>
                        ...
                        <View style={twrnc`flex-row items-center justify-between px-2 border-b py-3 border-[#a3a3a3]`}>
                            <View style={twrnc`flex-row items-center gap-5`}>
                                <Feather name="phone" size={28} color="#a3a3a3" />
                                <Text style={twrnc`text-base font-bold`}>(11) 9 3229-1233</Text>
                            </View>
                        ...
                        <View style={twrnc`flex-row items-center gap-5 px-2 border-b py-3 border-[#a3a3a3]`}>
                            ...
                            <View style={twrnc`flex-row items-end`}>
                                ...
                                <Text style={twrnc`text-xs font-bold`}>km</Text>
                                <Text style={twrnc`text-base font-bold`}> de você</Text>
                            </View>
                        </View>
                        <View style={twrnc`flex-row items-center gap-4 px-2 border-b py-3 border-[#a3a3a3]`}>
                            ...
                            <View style={twrnc`flex-row items-end`}>
                                <Text style={twrnc`text-base font-bold`}>A corrida tem 12</Text>
                                <Text style={twrnc`text-xs font-bold`}>
                                    km
                                </Text>
                            </View>
                        </View>
